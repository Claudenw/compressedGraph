...
public class CompressedNodeTest {
	...
	private CompressedNode roundTrip( CompressedNode cn ) throws IOException, ClassNotFoundException
	{
		...
		CompressedNode cn2 = (CompressedNode) is.readObject();
	...
	public void testLongStringLiteralRoundTrip() throws Exception
	{
		...
		CompressedNode cn = new CompressedNode( n, 1 );
		CompressedNode cn2 = roundTrip( cn );
	...
	{
		LiteralLabel ll = LiteralLabelFactory.create( Long.valueOf(Long.MAX_VALUE));
		Node n = NodeFactory.createLiteral( ll );
	...
	{
		CompressedNode cn = new CompressedNode( Node.ANY, 1 );
		CompressedNode cn2 = roundTrip( cn );
