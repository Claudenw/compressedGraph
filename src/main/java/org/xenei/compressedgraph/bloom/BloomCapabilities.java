...
public interface BloomCapabilities {
	 ...
	 * 
	 * 
	 * to support bloom query the underlying data store must match the bit
	 * patterns as per the bloom filter definition
	 ...
	 * when the exact flag is set on the find method then this should return
	 * true.
	 * 
	 */
	 ...
	 * 
	 * @param bloomValue
	 *            The 4 byte bloom value used for searching
	 * @param data
	 *            the data to write.
	 */
	 ...
	 * 
	 * @param bloomValue
	 *            the 4 byte bloom value to use for searching.
	 * @param exact
